...
class MQTTClient;
extern MQTTClient mqtt; // pozwala na wywołanie updateConfig z WebServerUI
...
public:
  ...
  void subscribeTopics() {
    ...
    // Dodaj kolejne tematy, jeśli potrzeba
  }
  ...
  void onMessage(char* topic, byte* payload, unsigned int length) {
    ...
    // Dodaj obsługę innych tematów jeśli chcesz
  }
  ...
  void publishStatus(bool force = false) {
    ...
    // Dodaj logi, harmonogramy itd. jeśli chcesz
  }
};

// Deklaracja globalnego obiektu
#ifdef MAIN_CPP
MQTTClient mqtt;
#else
