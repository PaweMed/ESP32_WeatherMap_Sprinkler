...
// Deklaracja funkcji z main.cpp do dynamicznej zmiany strefy czasowej (poprawiona wersja)
...
<head>
  ...
  <style>
    ...
    .bar { background: #3685c9; height: 18px; border-radius: 8px; width: 0%; }
  </style>
</head>
<body>
...
namespace WebServerUI {
  ...
  void begin(
    ...
    // --- OTA – upload bin (zgodnie z API ESPAsyncWebServer!)
